...
/// (groups + grant levels), used by <see cref="GetUserProfileCommandHandler"/> to override the default
/// <c>IGetUserProfileQCommand</c> handler so the Angular user-service <c>isAdmin</c> signal works.
/// Mirrors the helper in CK.Ng.Admin.Tests.
/// </summary>
